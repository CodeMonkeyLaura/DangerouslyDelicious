...
using DangerouslyDelicious.SimpleOAuthXamarin.Utilities;
...
namespace DangerouslyDelicious.SimpleOAuthXamarin
{
    ...
    public sealed class OAuthRequestWrapper
    {
        ...
        private string _oauthVersion = DefaultOAuthVersion;
        /// <summary>
        ...
        private void CreateSignature()
        {
            ...
            // signature time!
            string signature = SignatureMethod.CreateSignature(SigningMethod, encodedParams, key);
